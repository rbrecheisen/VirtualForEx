...
class Trader:
    def __init__(self):
        ...
        self._risk = 0
        self._pip = 0.0001
        self._calculate_stop_loss = True
    ...
    def set_calculate_stop_loss(self, calculate_stop_loss):
        self._calculate_stop_loss = calculate_stop_loss
